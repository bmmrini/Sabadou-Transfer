...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="page-header-soft py-20 text-center relative overflow-hidden">
        <div className="absolute inset-0 page-header-soft-overlay"></div>
        <div className="absolute inset-0 bg-dot-pattern opacity-5"></div>
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-display text-gray-900">Blog & Actualités</h1>
