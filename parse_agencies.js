...
const data = `Region	Prefecture	Commune	S/P, Village, Commune	Agency Name	Nom Agence	Chef d'Agence	Location	Localisation	No. Telephone
...
for (let i = 1; i < data_rows.length; i++) {
    const parts = data_rows[i];

    // Adjust indices based on visual inspection of the node script data string
    // 0: Region, 1: Prefecture, 2: Commune, 3: S/P, 4: Agency Name, 5: Nom Agence, 6: Chef, 7: Location, 8: Localisation, 9: Phone
